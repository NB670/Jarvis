...
export async function POST(req: Request) {
  try {
    const body = (await req.json()) as { message?: string; images?: string[]; conversationId?: string; voice?: boolean };
    ...
    const result = await runJarvisChat(text, images, conversationId, voice);
